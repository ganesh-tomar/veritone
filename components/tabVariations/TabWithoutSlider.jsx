  ...
  return (
    <section className={`tabs padding-medium ${styles.tabs} ${styles.tabWithoutSlider} overflow-x-clip`}>
      <div className={`container ${styles.container} `} >
        <div className={`wrapp`}>
          <div className={`${styles.tabValBox} tabValBox ${openit ? styles.expand : ''} sm-up:hidden`} onClick={dropdownHandler}>
          ...
          <div className={`${styles.listBox} listBox ${openit ? styles.expand : ''}`}>
