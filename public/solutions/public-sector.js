...
export const publicBanner = {
  ...
  buttonUrl: "",
  formUrl:
    "https://unlock.veritone.com/l/636301/2023-04-27/4cx8sc?source=https://www.veritone.com/solutions/media-entertainment/",
...
export const publicTabs = {
  ...
  tab_content: [
    {
      tab_title:
        "Spend less time and money, provide more public trust and transparency.        ",
      blurb:
      ...
      imgpath: "/images/public-sector/state-local_a.jpg",
      alt: "cameraman",
      imgpath2: "/images/public-sector/state-local_b.jpg",
      alt2: "camera",
      imgpath3: "/images/public-sector/police_one.jpg",
      alt3: "camera_lens",
      logo: "/images/public-sector/policeOne_logo_white.svg",
      logo_alt: "gray_logo",
      inner_title: "Police 1        ",
      inner_blurb:
        "Learn about iDEMS, Veritone’s AI-powered digital evidence management system, and how it can accelerate investigations.        ",
    ...
    },
    {
      ...
      imgpath: "/images/public-sector/education_a.jpg",
      alt: "woman_with_mic",
      imgpath2: "/images/public-sector/education_b.jpg",
      alt2: "aplifier_keys",
      imgpath3: "/images/public-sector/chesa.jpg",
      alt3: "mic",
      logo: "/images/public-sector/chesaLogo.png",
      logo_alt: "CHESA",
      inner_title: "CHESA",
      inner_blurb:
      ...
      bottom_btn_url:
        "https://investors.veritone.com/news-events/press-releases/detail/295/veritone-partners-with-chesa-to-streamline-the-u-s-federal",
      bottom_link_text: "",
      bottom_link_url: "",
    },
    {
      tab_title:
        "Take the hassle out of time-consuming workflows and meet FOIA deadlines with ease.        ",
      blurb:
      ...
      imgpath: "/images/public-sector/fed_civ_a.jpg",
      alt: "filming",
      imgpath2: "/images/public-sector/fedciv_b.jpg",
      alt2: "screens",
      imgpath3: "/images/public-sector/opexus.jpg",
      alt3: "reel",
      logo: "/images/public-sector/opexusLogo.png",
      logo_alt: "progress",
      inner_title: "OPEXUS",
      inner_blurb:
      ...
      bottom_btn_url:
        "https://www.opexustech.com/wp-content/uploads/2023/12/FOIAXPress-Veritone-.pdf",
      bottom_link_text: "",
      bottom_link_url: "",
    },
    {
      ...
      imgpath: "/images/public-sector/DoD_a.jpg",
      alt: "legal",
      imgpath2: "/images/public-sector/DoD_b.jpg",
      alt2: "legal",
      imgpath3: "/images/public-sector/GroupDOD.jpg",
      alt3: "illuminate_screencap",
      logo: "",
      logo_alt: "illuminate",
    ...
    },
    {
      ...
      alt2: "legal",
      imgpath3: "/images/public-sector/illuminate_screencap.jpg",
      alt3: "illuminate_screencap",
      logo: "",
      logo_alt: "24_logo",
      ...
      videoUrl:
        "https://player.vimeo.com/video/375771167?loop=false&autoplay=false&muted=false&gesture=media&playsinline=false&byline=false&portrait=false&title=false&speed=true&transparent=false&customControls=true",
      bottom_btn_url: "",
      bottom_link_text: "",
      bottom_link_url: "",
    },
...
export const publicTwitterSliderData = {
  intro: {
    title: "What’s new in Public Sector.",
    btnText: "View all",
    btnUrl: "/",
  ...
  cards: [
    ...
    },
    {
      ...
      clientImage:
        "/images/twitterSlider/government-technology-logo-200x112.png",
    ...
    },
    {
      ...
      clientImage: "/images/public-sector/veritone_ps_logo.jpg",
      userName: "@veritone-public-sector",
      url: "https://www.linkedin.com/posts/veritone-public-sector_introducing-veritone-public-sector-our-activity-7185660671924023299-6Mkh?utm_source=share&utm_medium=member_desktop",
      categories: ["veritone"],
    },
    {
      imageSrc: "/images/public-sector/consulting.jpg",
      imageName: "rebrand",
...
export const publicIntroWithAccordionData1 = {
  ...
  intro: {
    title:
      "Aggregate your audio, video, and image-based evidence files into one central hub.      ",
    blurb:
...
export const publicIntroWithAccordionData2 = {
  ...
  intro: {
    ...
    blurb:
      "Veritone empowers agencies to leverage best-of-breed AI models to analyze text-, video-, and audio-based evidence files with exceptional efficiency, extracting deeper insights to expedite case resolution.      ",
    btnText: "Learn more",
    btnClass: "btn-black",
...
export const publicIntroWithAccordionData4 = {
  ...
  intro: {
    title:
      "Automate redaction workflows and give your team the support they need to focus on more mission-critical tasks.      ",
    blurb:
  ...
  accordionData: [
    ...
    },
    {
      ...
      paragraph:
        "Constant exposure to video footage of criminal acts, especially violent ones, can negatively impact your team, resulting in burnout and increased turnover rates. Enhance efficiency and productivity by redirecting your team’s focus towards higher-priority tasks instead.        ",
    },
  ],
};
export const publicIntroWithAccordionData3 = {
  ...
  intro: {
    title:
      "Accelerate case investigations using AI technology that improves transparency and trust.",
    blurb:
...
export const publicAccordionData = {
  intro: {
    title:
      "Innovative AI solutions for people who want to help other people.      ",
  },
  items: [
    {
      id: 1,
    ...
    },
    {
      id: 2,
      heading:
        "Organize and share evidence faster with an intelligent evidence hub        ",
    ...
    },
    {
      id: 5,
      heading:
        "Streamline case investigations and clearances with relevant data.",
    ...
    },
    {
      id: 6,
      heading:
        "Automate the collection and reporting of RIPA-compliant stop data information.        ",
    ...
    },
    {
      id: 9,
      heading:
        "Transform the way you hire with programmatic job advertising.        ",
...
export const publicColTwoCards = {
  intro: {
    title:
      "AI-powered services to help your team keep up with high demands.      ",
    blurb:
...
export const publicResourceCards = {
  intro: {
    ...
    btnText: "View all",
    btnUrl:
      "https://www.veritone.com/resource-library/?vertical%5B%5D=compliance&vertical%5B%5D=government&vertical%5B%5D=justice&vertical%5B%5D=legal&vertical%5B%5D=public-safety",
    btnClass: "black-border-btn",
  },
  pageBg: "ultraviolet",
  cards: [
    {
      ...
      heading:
        "TransPerfect Legal Solutions reduces document review size by 65%.        ",
      blurb:
...
export const publicFooterCta = {
  title:
    "Help your team get back to what truly matters with powerful AI solutions.",
  description:
  ...
  btnClass1: "default",
  formUrl:
    "https://unlock.veritone.com/l/636301/2023-04-27/4cx8sc?source=https://www.veritone.com/",
  btnUrl1: "/",
  btnText2: "",
  btnClass2: "",
  btnUrl2: "",
