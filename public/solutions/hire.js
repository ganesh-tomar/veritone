...
export const hireBanner = {
  ...
  export const hireTwitterSliderData = {
    ...
    cards: [
      ...
      {
        imageSrc: '/images/hire/benzinga_youtube.jpg',
        ...
        client: 'Benzinga',
        clientImage: '/images/hire/benzinga_logo.jpeg',
      ...
      {
        imageSrc: '/images/hire/ihr.jpg',
        imageName: 'ihr',
        desc: "Happening soon 🗓 Don't miss out on the big event for In-house Recruitment Leaders! Dive into thought leadership presentations and engage in meaningful peer-to-peer roundtable discussions designed to elevate your recruitment strategies.",
        client: 'Veritone',
        clientImage: '/images/hire/veritone_hire__logo.jpg',
        userName: '@veritone-inc',
        url: 'https://www.linkedin.com/posts/veritone-hire_join-us-for-thought-leadership-presentations-activity-7188290872252235778-ZB4b?utm_source=share&utm_medium=member_desktop',
        categories: ['veritone'],
      },
      {
        imageSrc: '/images/hire/rebrand-hire.jpg',
        imageName: 'rebrand-hire',
        desc: "Today, we are pleased to announce that Broadbean Technology and PandoLogic are now Veritone Hire! Veritone Hire is redefining recruiting and talent acquisition by combining global job distribution tools with programmatic advertising AI technology to optimize recruiting strategies, reduce costs, improve efficiency and positively impact the most important asset to an organization – its people.",
        client: 'Veritone',
        clientImage: '/images/hire/veritone_hire__logo.jpg',
        userName: '@veritone-inc',
        url: 'https://www.linkedin.com/posts/veritone-hire_today-we-are-pleased-to-announce-that-broadbean-activity-7185660654614130688-6oc5?utm_source=share&utm_medium=member_desktop',
        categories: ['veritone'],
      },
    ],
  };
